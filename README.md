...
A guide and reference for adding items to your own [Icarus](https://store.steampowered.com/app/1149460/Icarus/) save file, written specifically for players running the game on **Linux via Proton/Steam Play** (most existing guides assume Windows).
...
1. Read `manual-editar-inventario-icarus-linux.md` from the top — it explains where your save lives under Proton, how to back it up, and how to run the editing script.
2. Use `index.html` (or the plain Markdown table) to look up the **internal name** of the item you want, plus its max stack size.
3. Follow the script template in the manual to add, edit, or remove that item in your save.
...
- [N30Z/icarus-save-editor](https://github.com/N30Z/icarus-save-editor) — the save-editing toolkit and the extracted game data tables this reference is built from.
- [AgentKush/Icarus-Save-file-Toolkit](https://github.com/AgentKush/Icarus-Save-file-Toolkit) — extracted item icons used in `index.html`.
